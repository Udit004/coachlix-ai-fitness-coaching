    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md shadow-lg">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 relative">
          <div className="flex items-center justify-start gap-4 w-full pr-10">
            <div className="flex items-center justify-center text-center w-12 h-12 bg-red-100 dark:bg-red-900/30 rounded-full flex-shrink-0">
          ...
          <button
            onClick={onClose}
            disabled={isLoading}
            className="absolute top-6 right-4 p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors disabled:opacity-50 cursor-pointer"
          >
            <X className="h-6 w-6" />
          </button>
        </div>
        ...
        <div className="p-6">
          ...
          {itemName && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30 rounded-lg p-3 mb-6">
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-white truncate mt-1">{itemName}</p>
            </div>
          )}
