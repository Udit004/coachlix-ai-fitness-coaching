...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-50 to-blue-50 border-t border-gray-100">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className={`bg-white p-3 rounded-full shadow-sm hover:shadow-md transform hover:-translate-y-1 transition-all duration-200 text-gray-600 ${social.color}`}
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-gray-600 hover:text-blue-600 text-sm transition-colors duration-200 hover:underline"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex w-full md:w-auto max-w-md">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-l-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
              />
