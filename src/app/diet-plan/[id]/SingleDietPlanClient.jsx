...
export default function SingleDietPlanClient({ planId }) {
  ...
  }, [planId, selectedPlanId, setSelectedPlanId, setActiveDay, router]);
            ...
            {dietPlan.days
              ...
              .map((day) => (
                <DietDayCard
                  ...
                  day={day}
                  planId={dietPlan._id}
                  onUpdate={async () => await refetch()} // Now properly awaitable
                />
              ))}
          </div>
        ) : (
