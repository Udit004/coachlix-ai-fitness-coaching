    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">Start your fitness journey today</p>
        </div>
        ...
        <div className="bg-gray-800 shadow-2xl rounded-2xl p-8 border border-gray-700">
          {signupSuccess && (
            <div className="mb-6 p-4 bg-green-900 border border-green-700 rounded-lg flex items-center space-x-2">
              ...
              <span className="text-green-300 font-medium">Account created successfully! Redirecting...</span>
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`appearance-none block w-full pl-10 pr-3 py-3 border ${errors.fullName ? 'border-red-500' : 'border-gray-600'} bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                  placeholder="Enter your full name"
                />
              </div>
              {errors.fullName && <p className="mt-1 text-sm text-red-400 flex items-center"><AlertCircle className="w-4 h-4 mr-1" />{errors.fullName}</p>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`appearance-none block w-full pl-10 pr-3 py-3 border ${errors.email ? 'border-red-500' : 'border-gray-600'} bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`appearance-none block w-full pl-10 pr-10 py-3 border ${errors.password ? 'border-red-500' : 'border-gray-600'} bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
              ...
              {errors.password && <p className="mt-1 text-sm text-red-400 flex items-center"><AlertCircle className="w-4 h-4 mr-1" />{errors.password}</p>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`appearance-none block w-full pl-3 pr-10 py-3 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-600'} bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
              ...
              {errors.confirmPassword && <p className="mt-1 text-sm text-red-400 flex items-center"><AlertCircle className="w-4 h-4 mr-1" />{errors.confirmPassword}</p>}
            </div>

            {errors.submit && <p className="p-2 text-sm bg-red-900 text-red-300 border border-red-700 rounded flex items-center"><AlertCircle className="w-4 h-4 mr-1" />{errors.submit}</p>}
