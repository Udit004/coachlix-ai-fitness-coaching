...
export default function WorkoutSessionPage() {
  ...
  const handleAddExercise = () => {
    router.push(`/workout-plan/${planId}/add-exercise?week=${weekNumber}&day=${dayNumber}&workout=${workoutId}&return=session`);
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading workout session...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto p-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">Total Time</span>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Target Sets</p>
                    <p className="text-2xl font-bold text-blue-900 dark:text-blue-100">
                      {currentExercise.targetSets || 3}
                    </p>
                  </div>
                  <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <p className="text-sm text-green-600 dark:text-green-400 font-medium">Target Reps</p>
                    <p className="text-2xl font-bold text-green-900 dark:text-green-100">
                      {currentExercise.targetReps || '8-12'}
                    </p>
                  </div>
                  <div className="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    <p className="text-sm text-purple-600 dark:text-purple-400 font-medium">Weight</p>
                    <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">
                      {currentExercise.targetWeight ? `${currentExercise.targetWeight}kg` : 'Body weight'}
                    </p>
                  </div>
                </div>
                ...
                {exerciseData[currentExerciseIndex]?.sets?.length > 0 && (
                  <div className="mb-6">
                    <h4 className="font-medium text-gray-900 dark:text-white mb-3">Completed Sets:</h4>
                    <div className="space-y-2">
                      {exerciseData[currentExerciseIndex].sets.map((set, index) => (
                        <div key={index} className="flex justify-between items-center text-sm bg-green-50 dark:bg-green-900/20 px-4 py-3 rounded-lg">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm h-fit sticky top-24">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-900 dark:text-white">Exercise List</h3>
              <button
                onClick={handleAddExercise}
              ...
              {exercises.map((exercise, index) => (
                ...
                >
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
                    <p>{exercise.targetSets || 3} sets × {exercise.targetReps || '8-12'} reps</p>
